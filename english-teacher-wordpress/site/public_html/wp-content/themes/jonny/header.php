...
<div class="sidebar-menu">
    ...
    <div class="menu-footer right-boxed">
        ...
        <div class="copy">
			<?php
			echo wp_kses_post(
				do_shortcode( ( get_theme_mod( 'side_menu_copyright', ' &copy; ' . esc_html__( 'Z11 Digital & &copy; More Idea ', 'jonny' ) . date('Y').esc_html__('. All Rights Resevered ', 'jonny' ) .  '' . '' ) ) ) ); ?>
        </div>
    </div>
</div>
<!-- Navbar -->

<header class="navbar navbar-2 navbar-white boxed <?php  if(!is_front_page()  && !jonny_is_single_project()){ ?> navbar-fixed <?php  } ?>">
