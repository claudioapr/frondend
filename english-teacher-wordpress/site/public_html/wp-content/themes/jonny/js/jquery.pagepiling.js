        ...
        */
        function addVerticalNavigation(){
            ...
            for(var cont = 0; cont < $('.pp-section').length; cont++){
                ...
                if(link === 'page2'){
                    titleTooltip = 'Pablo Souto';
                }
                if(link === 'page3'){
                    titleTooltip = 'Serviços';
                }
                if(link === 'page4'){
                    titleTooltip = 'Experiências';
                }
                if(link === 'page5'){
                    titleTooltip = 'Artigos';
                }
                if(link === 'page6'){
                    titleTooltip = 'Depoimentos';
                }
                if(link === 'page7'){
                    titleTooltip = 'Contato';
                }
                
                nav.find('ul').append('<li data-tooltip="' + tooltip + '" title="' + titleTooltip + '" ><a href="#' + link + '"><span></span></a></li>');
            }
         ...
         */
         function activateNavDots(name, sectionIndex){
            if(options.navigation){
                ...
                if(name){
                    $('#pp-nav').removeClass('black');
                    $('#pp-nav').addClass('white');
               /**     if(name==='page2'){
                        $('#pp-nav').removeClass('white');
                        $('#pp-nav').addClass('black');
                    }
                */
