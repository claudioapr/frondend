								...
								<div class="intro">
									<div class="row">
										<div class="col-md-5 col-lg-12">
											...
											<p class="subtitle-top text-primary"><?php echo esc_html( $atts['t'] ); ?></p>
											<?php } ?>
											...
											<div class="col-md-6 col-lg-5 col-md-offset-1 col-lg-offset-2">
												<div class="dots-image-2">
													<?php if ( isset( $img_arr{1} ) ) {
														?>
														<img alt="" class="img-xp img-responsive"
														...
														<div class="col-resume">
															...
															<div class="resume-content">
																<div class="resume-inner">
																	...
																	<p class="resume-text"><?php echo esc_html( $item2['text'] ); ?> 
																		<a href="<?php if ( isset( $item2['url'][0] ) ) {
																			echo esc_attr( $item2['url'] );
																		} ?>">
																		<?php if ( isset( $item2['resume_link'][0] ) ) {
																			echo esc_html( $item2['resume_link'] );
																		} ?></a>
																	</p>
