...
$('#primeiro-paragrafo').on('show.bs.collapse', 
	function() {
		...
		if(w <= 480){
			f1 = false;
			$('.botao').css('transform', 'translate(0%, 200%)');
			$('.zed').css('transform', 'translate(0%, 200%)');
			$('.inpt-email').css('transform', 'translate(0%, 200%)');
			$('.titulo-email').css('transform', 'translate(0%, 200%)');
			$('.zed').css('transform', 'translate(0%, 200%)');
			$('.img-face').css('transform', 'translate(0%, 0%)');
			$('.img-insta').css('transform', 'translate(0%, 	0%');
		}
...
$('#quarto-paragrafo').on('show.bs.collapse', function() {
	...
	var w = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
	if(w <= 480){
		$('.botao').css('transform', 'translate(0%, 600%)');
		$('.zed').css('transform', 'translate(0%, 560%)');
		$('.inpt-email').css('transform', 'translate(0%, 600%)');
		$('.titulo-email').css('transform', 'translate(0%, 560%)');
		$('.img-face').css('transform', 'translate(0%, 560%)');
		$('.img-insta').css('transform', 'translate(0%, 560%)');
