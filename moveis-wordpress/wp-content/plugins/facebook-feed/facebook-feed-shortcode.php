	    ...
	    if (array_key_exists('story_tags',$mysinglefeed ))
            {
				...
				{ 
					$mystorytagname = $mystorytag->name; 
					if($atts['link_target']==1)	{
					$tag_link = '<a class="wff-link-tab" href="http://facebook.com/' . $mystorytag->id . '" style="color: indigo;" target="_blank">' . $mystorytag->name . '</a>';
					} else {
					$tag_link = '<a class="wff-link-tab" href="http://facebook.com/' . $mystorytag->id . '" style="color: indigo;" >' . $mystorytag->name . '</a>';
					}
	     	...
	     	if (isset($mysinglefeed->message) && !empty($mysinglefeed->message))
	     	{
				...
				{ 
                    $mymessagetagname = $mymessagetag->name; 
					if($atts['link_target']==1)	{				
					$tag_link = '<a class="wff-link-tab" href="http://facebook.com/' . $mymessagetag->id . '" style="color: red;" target="_blank">' . $mymessagetag->name . '</a>';
					} else {
					$tag_link = '<a class="wff-link-tab" href="http://facebook.com/' . $mymessagetag->id . '" style="color: red;" >' . $mymessagetag->name . '</a>';
					}
